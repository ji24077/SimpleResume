...
`tests/golden/` 에 샘플 입력·기대 해시를 두고, **GitHub Actions** (`.github/workflows/ci.yml`) 에서 `pytest tests/golden` 으로 검증합니다.  
자세한 정책은 [tests/golden/README.md](../tests/golden/README.md) 를 참고하세요.
